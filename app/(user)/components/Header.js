...
export default function Header() {
  ...
  return (
    <>
      ...
      {/* Right Sidebar */}
      <div
        className={`fixed top-0 right-0 h-full w-70 bg-[#1a5f6f] z-70 transform transition-transform duration-300 ease-in-out ${sidebarOpen ? "translate-x-0" : "translate-x-full"}`}
      >
        {/* Close Button */}
